...
/**
 * 查询按钮必须使用查询DefaultQueryAction
 * 
 * @author qiaoyanga
 * @since 1.0.0.0
 */
@RuleDefinition(executePeriod = ExecutePeriod.DEPLOY, catalog = CatalogEnum.UIFACTORY, subCatalog = SubCatalogEnum.UF_BTNOREVENT, description = "查询按钮必须使用查询DefaultQueryAction", coder = "qiaoyanga", relatedIssueId = "194")
public class TestCase00194 extends AbstractXmlRuleDefinition {
    @Override
    ...
    protected IRuleExecuteResult processScriptRules(IRuleExecuteContext ruleExecContext, List<XmlResource> resources)
        ...
        for (XmlResource xmlResource : resources) {
            ...
            if (!hasAction) {
                noteBuilder.append("没有找到正确的查询按钮类 \n");
            }
