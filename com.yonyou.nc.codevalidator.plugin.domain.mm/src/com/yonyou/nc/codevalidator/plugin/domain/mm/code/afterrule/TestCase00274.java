...
/**
 * 新增单据时，后规则中，流程制造使用MMDownBillRewriter框架 回写来源单据的规则，差量回写，需要使用本领域的通用回写框架
 * 
 * @since 6.0
 * @version 2013-11-6 上午10:44:15
 * @author zhongcha
 */
@RuleDefinition(catalog = CatalogEnum.JAVACODE, subCatalog = SubCatalogEnum.JC_CODECRITERION, description = "删除时，后规则中回写来源单据的规则，差量回写，需要使用本领域的通用回写框架【单据可选】", relatedIssueId = "274", coder = "zhongcha", solution = "通过关键字符*InsertBP取bs包下的*InsertBP.java文件;再判断BP和Rule中是否引用了本领域的回写框架【流程制造回写框架MMDownBillRewriter】,回写规则以Rewrite开头，并以Rule结尾;"
...
public class TestCase00274 extends AbstractJavaQueryRuleDefinition {
    ...
    protected IRuleExecuteResult processJavaRules(IRuleExecuteContext ruleExecContext, List<JavaClassResource> resources)
        ...
        String paramValue = ruleExecContext.getParameter(TestCase00274.PARAM_NAME);
