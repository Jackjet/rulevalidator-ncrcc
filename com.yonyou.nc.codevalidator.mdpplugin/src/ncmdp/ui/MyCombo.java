 ...
 * </dl>
 */
public final class MyCombo extends Composite {
...
public MyCombo (Composite parent, int style) {
	...
	filter = new Listener() {
		public void handleEvent(Event event) {
			...
			if (shell == MyCombo.this.getShell ()) {
				handleFocus (SWT.FocusOut);
			}
		}
	};
...
void createPopup(String[] items, int selectionIndex) {		
		...
		int style = getStyle ();
		int listStyle = SWT.SINGLE | SWT.V_SCROLL |SWT.H_SCROLL|SWT.RESIZE;
