...
import ncmdp.views.busioperation.BusiOPTableModifier;
...
/**
 * 
 * @author dingxm   2010-4-7
 *
 */
public class BusiActivityView extends Composite {
	private TableViewer tableView = null;

	private CellPart cellPart = null;

	public BusiActivityView(Composite parent, int style) {
		super(parent, style);
	...
	private void createPartControl(Composite parent) {
		...
		BusiActivityMenuActionGroup actionGroup = new BusiActivityMenuActionGroup(this);
	...
	private void createTableView(Composite parent) {
		...
		//4£©
		tableView.setContentProvider(new BusiActTableContentProvider());
		tableView.setLabelProvider(new BusiActTableViewerProvider());
		tableView.setCellModifier(new BusiActTableModifier(tableView));
		//5£©
