 ...
 *
 */
public class ElementObj implements Cloneable, Serializable, IPropertySource {
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		pds[0] = new TextPropertyDescriptor(PROP_ELEMENT_NAME, Messages.ElementObj_14);
		pds[1] = new TextPropertyDescriptor(PROP_ELEMENT_DISPLAY_NAME, Messages.ElementObj_15);
		pds[2] = new NotEditableTextPropertyDescriptor(PROP_ID, "ID"); 
		pds[3] = new TextPropertyDescriptor(PROP_DESCRIPTION, Messages.ElementObj_17);
		pds[4] = new TextPropertyDescriptor(PROP_CREATOR, Messages.ElementObj_18);
		pds[5] = new NotEditableTextPropertyDescriptor(PROP_CREATE_TIME, Messages.ElementObj_19);
		pds[6] = new TextPropertyDescriptor(PROP_MODIFIER, Messages.ElementObj_20);
		pds[7] = new NotEditableTextPropertyDescriptor(PROP_MODIFIER_TIME,
				Messages.ElementObj_21);
		pds[8] = new TextPropertyDescriptor(PROP_EXTEND_TAG, Messages.ElementObj_22);
		for (int i = 0; i < pds.length; i++) {
			pds[i].setCategory(Messages.ElementObj_23);
		}
		return pds;
	}
