 ...
 *
 */
public class AttrMoveUpAction extends Action {
	private class AttrMoveupCommand extends Command {
		...
		public AttrMoveupCommand(List<Attribute> al, int index) {
			super(Messages.AttrMoveUpAction_0);
			this.al = al;
			this.index = index;
		}
	...
	public AttrMoveUpAction(CellPropertiesView view) {
		super(Messages.AttrMoveUpAction_1);
		this.view = view;
	}
