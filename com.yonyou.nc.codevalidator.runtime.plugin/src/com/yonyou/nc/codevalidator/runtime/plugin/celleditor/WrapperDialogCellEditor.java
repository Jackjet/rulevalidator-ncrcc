...
/**
 * 包装后的DialogCellEditor
 * 
 * @author mazqa
 * @date 2010-11-3
 * @since UFESB2.0
 */
public abstract class WrapperDialogCellEditor extends DialogCellEditor {
	...
	static {
		...
		reg.put(CELL_EDITOR_IMG_DOTS_BUTTON, ImageDescriptor.createFromFile(DialogCellEditor.class,
	...
	private class DialogCellLayout extends Layout {
		public void layout(Composite editor, boolean force) {
			...
			Point size = button.computeSize(16, 16, force);
			if (contents != null) {
	 ...
	 * @since 2.1
	 */
	public WrapperDialogCellEditor() {
	 ...
	 *            the parent control
	 */
	protected WrapperDialogCellEditor(Composite parent) {
	 ...
	 * @since 2.1
	 */
	protected WrapperDialogCellEditor(Composite parent, int style) {
		super(parent, style);
	}
...
//					WrapperDialogCellEditor.this.focusLost();
				}
			};
		}
...
//		URL resUrl = Platform.getBundle("com.ufida.eip.toolkit.gef").getResource("/icons/refpane/ref.gif");
//		result.setImage(ImageDescriptor.createFromURL(resUrl).createImage());
		result.setImage(Activator.imageFromPlugin("/images/ref.gif"));
		return result;
	}
}
