...
public class CheckBoxFilterTreeTable extends Composite {
	 ...
	 */
	public CheckBoxFilterTreeTable(Composite parent, int treeStyle, PatternFilter filter) {
	 ...
	 * @since 3.5
	 */
	public CheckBoxFilterTreeTable(Composite parent, int treeStyle, PatternFilter filter, boolean useNewLook) {
		super(parent, SWT.NONE);
		this.parent = parent;
	 ...
	 *             look is encouraged
	 */
	protected CheckBoxFilterTreeTable(Composite parent) {
		super(parent, SWT.NONE);
		this.parent = parent;
	}
	 ...
	 * @since 3.5
	 */
	protected CheckBoxFilterTreeTable(Composite parent, boolean useNewLook) {
		super(parent, SWT.NONE);
		this.parent = parent;
		this.useNewLook = useNewLook;
	}
	...
	private void createClearTextOld(Composite parent) {
		...
		if ((filterText.getStyle() & SWT.ICON_CANCEL) == 0) {
			...
			clearTextAction.setDisabledImageDescriptor(JFaceResources.getImageRegistry().getDescriptor(
					DISABLED_CLEAR_ICON));
	 ...
	 * @return bold font
	 */
	public static Font getBoldFont(Object element, CheckBoxFilterTreeTable tree, PatternFilter filter) {
