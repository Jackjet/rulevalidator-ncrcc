 ...
 *
 */
public class Attribute implements Cloneable, Serializable, Constant,
		IMultiElement {
	...
	public void setElementAttribute(Element ele) {
		...
		ele.setAttribute("isAuthorization", isAuthorization() ? "true"  
				: "false"); 
		ele.setAttribute("isDefaultDimensionAttribute", 
				isDefaultDimensionAttribute() ? "true" : "false");  
		ele.setAttribute("isFeature", getIsFeature() ? "true" : "false");   
		ele.setAttribute("isDefaultMeasureAttribute", 
				isDefaultMeasureAttribute() ? "true" : "false");  
		ele.setAttribute("isGlobalization", isGlobalization() ? "true"  
				: "false"); 
	...
	public String genXMLAttrString() {
		...
		sb.append(ACCESS_POWER_GROUP + "='").append(this.getAccessPowerGroup()) 
				.append("' "); 
		sb.append("accessStrategy='").append(this.getAccessStrategy()) 
				.append("' "); 
		sb.append("visibility='").append(this.getVisibilityKind()).append("' ");  
		sb.append("isAuthorization='") 
				.append(this.isAuthorization() ? "true" : "false").append("' ");   
		sb.append("isDefaultDimensionAttribute='") 
				.append(this.isDefaultDimensionAttribute() ? "true" : "false")  
				.append("' "); 
		sb.append("isFeature='").append(this.getIsFeature() ? "true" : "false")   
				.append("' "); 
		sb.append("isDefaultMeasureAttribute='") 
				.append(this.isDefaultMeasureAttribute() ? "true" : "false")  
				.append("' "); 
		sb.append("isGlobalization='") 
				.append(this.isGlobalization() ? "true" : "false").append("' ");   
		sb.append("isHide='").append(this.isHide() ? "true" : "false")   
				.append("' "); 
		sb.append("isShare='").append(this.isShare() ? "true" : "false")   
				.append("' "); 
		sb.append("isKey='").append(this.isKey() ? "true" : "false")   
				.append("' "); 
		sb.append("isNullable='").append(this.isNullable() ? "true" : "false")   
				.append("' "); 
		sb.append(ACCESS_POWER + "='") 
				.append(this.isAccessPower() ? "true" : "false").append("' ");   
		sb.append("isReadOnly='").append(this.isReadOnly() ? "true" : "false")   
				.append("' "); 
		...
		sb.append(FORLOCALE).append("='") 
				.append(this.isForLocale() ? "true" : "false").append("' ");   
		sb.append("minValue='").append(this.getMinValue()).append("' ");  
		sb.append("maxValue='").append(this.getMaxValue()).append("' ");  
		sb.append("fixedLength='").append(this.isFixLen() ? "true" : "false")   
				.append("' "); 
		sb.append("length='").append(this.getLength()).append("' ");  
		sb.append("precise='").append(this.getPrecision()).append("' ");  
		sb.append("calculation='") 
				.append(this.isCalculateAttr() ? "true" : "false").append("' ");   
		sb.append("isActive='").append(this.isActive() ? "true" : "false")   
				.append("' "); 
		sb.append("refModelName='").append(this.getRefModuleName()) 
				.append("' "); 
		sb.append("resid='").append(this.getResid()).append("' ");  
		sb.append("notSerialize='") 
				.append(this.getIsSequence() ? "true" : "false").append("' ");   
		sb.append("dynamic='") 
				.append(this.getIsDynamicAttr() ? "true" : "false")  
				.append("' "); 
	...
	public void printXMLString(PrintWriter pw, String tabStr, int index,
			String classId) {
	...
	public static Attribute parseNode(Node node) {
		...
		if ("attribute".equalsIgnoreCase(name)) { 
			...
			if (map != null) {
				...
				attr.setDisplayName(map.getNamedItem("displayName") 
						.getNodeValue());
				if (map.getNamedItem("dataTypeStyle") != null){//类型
					attr.setTypeStyle(map.getNamedItem("dataTypeStyle") 
							.getNodeValue());
				}
				Type type = Type.parseType(map);
				if (type != null)
					attr.setType(type);
				attr.setDefaultValue(map.getNamedItem("defaultValue") 
						.getNodeValue());
				...
				if (map.getNamedItem(ACCESS_POWER_GROUP) != null) {//使用权组
					attr.setAccessPowerGroup(map.getNamedItem(
							ACCESS_POWER_GROUP).getNodeValue());
				}
				attr.setAccessStrategy(map.getNamedItem("accessStrategy") //访问策略
						.getNodeValue());
				attr.setVisibilityKind(map.getNamedItem("visibility") 
						.getNodeValue());
				attr.setAuthorization("true".equals(map.getNamedItem( //是否授权，貌似被隐藏了
						"isAuthorization").getNodeValue())); 
				attr.setDefaultDimensionAttribute("true".equals(map 
						.getNamedItem("isDefaultDimensionAttribute") 
						.getNodeValue()));
				if (map.getNamedItem("isFeature") != null) { 
					attr.setIsFeature("true".equals(map.getNamedItem( 
							"isFeature").getNodeValue())); 
				}

				attr.setDefaultMeasureAttribute("true".equals(map.getNamedItem( 
						"isDefaultMeasureAttribute").getNodeValue())); 
				attr.setGlobalization("true".equals(map.getNamedItem( 
						"isGlobalization").getNodeValue())); 
				attr.setHide("true".equals(map.getNamedItem("isHide")  
						.getNodeValue()));
				attr.setShare("true".equals(map.getNamedItem("isShare")  
						.getNodeValue()));
				attr.setKey("true".equals(map.getNamedItem("isKey")  
						.getNodeValue()));
				attr.setNullable("true".equals(map.getNamedItem("isNullable")  
						.getNodeValue()));
				if (map.getNamedItem(ACCESS_POWER) != null) {
					attr.setAccessPower("true".equals(map.getNamedItem( 
							ACCESS_POWER).getNodeValue()));
				}
				attr.setReadOnly("true".equals(map.getNamedItem("isReadOnly")  
						.getNodeValue()));
				if (map.getNamedItem("versionType") != null) { 
					attr.setVersionType(map.getNamedItem("versionType") 
							.getNodeValue());
				}
				if (map.getNamedItem("createIndustry") != null) { 
					attr.setCreateIndustry(map.getNamedItem("createIndustry") 
							.getNodeValue());
				}
				if (map.getNamedItem("modifyIndustry") != null) { 
					attr.setModifyIndustry(map.getNamedItem("modifyIndustry") 
							.getNodeValue());
				}
				if (map.getNamedItem("industryChanged") != null) { //增量开发中用到
					attr.setIndustryChanged("true".equals(map.getNamedItem( 
							"industryChanged").getNodeValue())); 
				}
				if (map.getNamedItem("isSource") != null) { //增量开发中用到
					attr.setSource("true".equals(map.getNamedItem("isSource")  
							.getNodeValue()));
				}

				if (map.getNamedItem("fieldName") != null) { 
					attr.setFieldName(map.getNamedItem("fieldName") 
							.getNodeValue());
				}
				if (map.getNamedItem("fieldType") != null) { //字段类型
					attr.setFieldType(map.getNamedItem("fieldType") 
							.getNodeValue());
				}
				if (map.getNamedItem(FORLOCALE) != null) {//支持本地语言
					attr.setForLocale("true".equalsIgnoreCase(map.getNamedItem( 
							FORLOCALE).getNodeValue()));
				}
				if (map.getNamedItem("minValue") != null) { 
					attr.setMinValue(map.getNamedItem("minValue") 
							.getNodeValue());
				}
				if (map.getNamedItem("maxValue") != null) { 
					attr.setMaxValue(map.getNamedItem("maxValue") 
							.getNodeValue());
				}
				if (map.getNamedItem("fixedLength") != null) { 
					attr.setFixLen("true".equalsIgnoreCase(map.getNamedItem( 
							"fixedLength").getNodeValue())); 
				}
				if (map.getNamedItem("length") != null) { 
					attr.setLength(map.getNamedItem("length").getNodeValue()); 
				}
				if (map.getNamedItem("precise") != null) { 
					attr.setPrecision(map.getNamedItem("precise") 
							.getNodeValue());
				}
				if (map.getNamedItem("calculation") != null) { //计算属性
					attr.setCalculateAttr("true".equalsIgnoreCase(map 
							.getNamedItem("calculation").getNodeValue())); 
				}
				if (map.getNamedItem("isActive") != null) { 
					attr.setActive("true".equalsIgnoreCase(map.getNamedItem( 
							"isActive").getNodeValue())); 
				}
				if (map.getNamedItem("refModelName") != null) { 
					attr.setRefModuleName(map.getNamedItem("refModelName") 
							.getNodeValue());
				}
				...
				if (map.getNamedItem("notSerialize") != null) { //可序列化
					attr.setIsSequence("true".equalsIgnoreCase(map 
							.getNamedItem("notSerialize").getNodeValue())); 
				}
				if (map.getNamedItem("dynamic") != null) { 
					attr.setIsDynamicAttr("true".equalsIgnoreCase(map 
							.getNamedItem("dynamic").getNodeValue())); 
				}
				if (map.getNamedItem("dynamicTable") != null) { 
					attr.setDynamicTable(map.getNamedItem("dynamicTable") 
							.getNodeValue());
				}
			}
		}
	...
	public void dealBeforeSave() {
		if (!NCMDPTool.isBaseType(type.getTypeId())
				&& "REF".equalsIgnoreCase(getTypeStyle())) { 
			if (isNullable()) {
...
//			if (!"20".equalsIgnoreCase(getLength()) 
//					&& !"36".equalsIgnoreCase(getLength())) { 
//				String message = Messages.Attribute_311
//						+ getName()
//						+ ":" 
//						+ getDisplayName()
//						+ Messages.Attribute_313
//						+ ""; 
//				setLength("20"); 
//				if (MessageDialog.openConfirm(NCMDPEditor.getActiveMDPEditor()
//						.getSite().getShell(), Messages.Attribute_315, message)) {
...
//			}
		...
		if (graph.isIndustryIncrease()) {
			...
			if (cell!=null&&cell.isSource()) {// 只针对原有实体，不针对行业新增实体
				if (!isSource() && !"ARRAY".equalsIgnoreCase(getTypeStyle())) {// 1)增量开发的属性 
																				// 2)非子表属性
					if (StringUtil.isEmptyWithTrim(getDynamicTable())
							&& !TYPE_STYLES[1].equalsIgnoreCase(typeStyle)) {
						sb.append(Messages.Attribute_328
								+ graph.getCellByID(getClassID()).getName()
								+ "." + getName() + "\r\n"); 
					} else {
						if (!getDynamicTable().endsWith(endTag)) {
							sb.append(Messages.Attribute_331 + endTag
									+ Messages.Attribute_332
									+ graph.getCellByID(getClassID()).getName()
									+ "." + getName() + "\r\n");
						}
					}
					...
					if (!getName().endsWith(endTag)) {
						sb.append(Messages.Attribute_335 + getName() + "::"
								+ getDisplayName() + Messages.Attribute_337 + endTag + Messages.Attribute_338
								+ "\r\n");
					}
				}
			}
	...
	public List<Prop> getEntityProps(){
		...
		if(!getAccessStrategy().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_15, "accessStrategy",
					this.getAccessStrategy()));
		}
		if(!getVisibilityKind().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_16, "visibilityKind",
					this.getVisibilityKind()));
		}
		if(!getDefaultValue().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_17, "defaultValue",
					this.getDefaultValue()));
		}
		if(!getMaxValue().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_18, "maxValue",
					this.getMaxValue()));
		}
		if(!getMinValue().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_19, "minValue",
					this.getMinValue()));
		}
		if(!getLength().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_20, "length",
					this.getLength()));
		}
		if(!getPrecision().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_21,"precision",
					this.getPrecision()));
		}
		props.add(new Prop(Messages.CellModifier_22, "isFixLen",
				this.isFixLen()));
		props.add(new Prop(Messages.CellModifier_23, "isCalculateAttr",
				this.isCalculateAttr()));
		props.add(new Prop(Messages.CellModifier_24, "isActive",
				this.isActive()));
		props.add(new Prop(Messages.CellModifier_25, "isAuthorization",
				this.isAuthorization()));
		if(!getResid().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_26, "resid",
					this.getResid()));
		}
		props.add(new Prop(Messages.CellModifier_28, "notSerialize",
				this.getIsSequence()));
		props.add(new Prop(Messages.CellModifier_29, "nynamic",
				this.getIsDynamicAttr()));
		if(!getDynamicTable().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_30, "dynamicTable",
					this.getDynamicTable()));
		}
		props.add(new Prop(Messages.CellModifier_31, "accessPower",
				this.isAccessPower()));
		if(!getAccessPowerGroup().trim().equals("")){
			props.add(new Prop(Messages.CellModifier_32, "accessPowerGroup",
					this.getAccessPowerGroup()));
		}
		props.add(new Prop(Messages.CellModifier_33, "forLocale",
				this.isForLocale()));
